...
The DonorsChoose website publishes a [blog](http://www.donorschoose.org/blog/) of how these donations are making an impact in classrooms all across USA. The stories that are told are very powerful.
...
<a id="displayText" href="javascript:toggle(4);">Schema Diagram</a>
...
<a id="displayText" href="javascript:toggle(1);">Code: C++ Utility </a>
...
<a id="displayText" href="javascript:toggle(2);">Code: Data Wrangling</a>
...
<a id="displayText" href="javascript:toggle(3);">Code: Data Upload from Disk</a>
...
<a id="displayText" href="javascript:toggle(3);">Code: Analysis of Distribution</a>
  <div id="toggleText3" style="display: none">
...
<a id="displayText" href="javascript:toggle(3);">Code: Assessing Normality</a>
  <div id="toggleText3" style="display: none">
```{r}
